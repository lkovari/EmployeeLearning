...
namespace EmployeeLearning.testdata.jobrolestore
{
    public sealed class JobRoleTestDataProvider
    {
        ...
        private JobRoleTestDataProvider()
        {
            ...
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole C", videosOfJobRole3));
            ...
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole E", videosOfJobRole4));
            ...
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole E", videosOfJobRole5));

            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole H", videosOfJobRole2));
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole G", videosOfJobRole3));
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole H", videosOfJobRole4));
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole I", videosOfJobRole5));
            JobRoles.Add(new JobRole(IdProvider.NewJobRoleId, "JobRole J", videosOfJobRole1));
        }
